...
//     [VarRef(x), TVar(14)],
//     [PrimOp(+), TVar(13)]])
export const expToPool = (exp: A.Exp): Pool => {  //  I think this fucntion which creaTS THE VARIBALES TYPES   t1=f .t2=g ... 
...
export const makeEquationsFromExp = (exp: A.Exp, pool: Pool): Opt.Optional<Equation[]> =>  // this fuunction creats the equations  meni page 84
...
export const solveEquations = (equations: Equation[]): Res.Result<S.Sub> =>   // this funciton takes the equations and solve it 
